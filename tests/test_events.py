...
class AIAircraftWasShotDownByHumanAircraftAndAIAircraftTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftWasShotDownByHumanAircraftAndAIAircraft.from_s(
            "[8:33:05 PM] r01000 shot down by User0:Bf-109G-2 and r01001 at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftWasShotDownByHumanAircraftAndAIAircraft)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraft("r0100", 0))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftWasShotDownByHumanAircraftAndAIAircraft(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraft("r0100", 0),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftWasShotDownByHumanAircraftAndAIAircraft",
                'verbose_name': "AI aircraft was shot down by human aircraft and AI aircraft",
            }
        )


class AIAircraftWasShotDownByAIAircraftAndHumanAircraftTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftWasShotDownByAIAircraftAndHumanAircraft.from_s(
            "[8:33:05 PM] r01000 shot down by r01001 and User0:Bf-109G-2 at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftWasShotDownByAIAircraftAndHumanAircraft)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraft("r0100", 0))
        self.assertEqual(event.attacker, actors.AIAircraft("r0100", 1))
        self.assertEqual(event.assistant, actors.HumanAircraft("User0", "Bf-109G-2"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))

    def test_to_primitive(self):
        event = events.AIAircraftWasShotDownByAIAircraftAndHumanAircraft(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraft("r0100", 0),
            attacker=actors.AIAircraft("r0100", 1),
            assistant=actors.HumanAircraft("User0", "Bf-109G-2"),
            pos=Point2D(100.0, 200.99),
        )
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftWasShotDownByAIAircraftAndHumanAircraft",
                'verbose_name': "AI aircraft was shot down by AI aircraft and human aircraft",
            }
        )
...
class AIAircraftCrewMemberWasKilledByMovingUnitTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberWasKilledByMovingUnit.from_s(
            "[8:33:05 PM] r01000(0) was killed by 0_Chief at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberWasKilledByMovingUnit)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.MovingUnit("0_Chief"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberWasKilledByMovingUnit(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.MovingUnit("0_Chief"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberWasKilledByMovingUnit",
                'verbose_name': "AI aircraft crew member was killed by moving unit",
            }
        )
...
class AIAircraftCrewMemberWasKilledInParachuteByStationaryUnitTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByStationaryUnit.from_s(
            "[8:33:05 PM] r01000(0) was killed in his chute by 0_Static at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberWasKilledInParachuteByStationaryUnit)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.StationaryUnit("0_Static"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByStationaryUnit(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.StationaryUnit("0_Static"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberWasKilledInParachuteByStationaryUnit",
                'verbose_name': "AI aircraft crew member was killed in parachute by stationary unit",
            }
        )


class AIAircraftCrewMemberWasKilledInParachuteByMovingUnitMemberTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByMovingUnitMember.from_s(
            "[8:33:05 PM] r01000(0) was killed in his chute by 0_Chief0 at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberWasKilledInParachuteByMovingUnitMember)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.MovingUnitMember("0_Chief", 0))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByMovingUnitMember(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.MovingUnitMember("0_Chief", 0),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberWasKilledInParachuteByMovingUnitMember",
                'verbose_name': "AI aircraft crew member was killed in parachute by moving unit member",
            }
        )


class AIAircraftCrewMemberWasKilledInParachuteByMovingUnitTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByMovingUnit.from_s(
            "[8:33:05 PM] r01000(0) was killed in his chute by 0_Chief at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberWasKilledInParachuteByMovingUnit)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.MovingUnit("0_Chief"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByMovingUnit(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.MovingUnit("0_Chief"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberWasKilledInParachuteByMovingUnit",
                'verbose_name': "AI aircraft crew member was killed in parachute by moving unit",
            }
        )


class AIAircraftCrewMemberWasKilledInParachuteByHumanAircraftTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByHumanAircraft.from_s(
            "[8:33:05 PM] r01000(0) was killed in his chute by User0:Bf-109G-2 at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberWasKilledInParachuteByHumanAircraft)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.HumanAircraft("User0", "Bf-109G-2"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberWasKilledInParachuteByHumanAircraft(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.HumanAircraft("User0", "Bf-109G-2"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberWasKilledInParachuteByHumanAircraft",
                'verbose_name': "AI aircraft crew member was killed in parachute by human aircraft",
            }
        )
...
class AIAircraftCrewMemberParachuteWasDestroyedByStationaryUnitTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByStationaryUnit.from_s(
            "[8:33:05 PM] r01000(0) has chute destroyed by 0_Static at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberParachuteWasDestroyedByStationaryUnit)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.StationaryUnit("0_Static"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByStationaryUnit(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.StationaryUnit("0_Static"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberParachuteWasDestroyedByStationaryUnit",
                'verbose_name': "AI aircraft crew member's parachute was destroyed by stationary unit",
            }
        )


class AIAircraftCrewMemberParachuteWasDestroyedByMovingUnitMemberTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByMovingUnitMember.from_s(
            "[8:33:05 PM] r01000(0) has chute destroyed by 0_Chief0 at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberParachuteWasDestroyedByMovingUnitMember)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.MovingUnitMember("0_Chief", 0))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByMovingUnitMember(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.MovingUnitMember("0_Chief", 0),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberParachuteWasDestroyedByMovingUnitMember",
                'verbose_name': "AI aircraft crew member's parachute was destroyed by moving unit member",
            }
        )


class AIAircraftCrewMemberParachuteWasDestroyedByMovingUnitTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByMovingUnit.from_s(
            "[8:33:05 PM] r01000(0) has chute destroyed by 0_Chief at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberParachuteWasDestroyedByMovingUnit)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.MovingUnit("0_Chief"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByMovingUnit(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.MovingUnit("0_Chief"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberParachuteWasDestroyedByMovingUnit",
                'verbose_name': "AI aircraft crew member's parachute was destroyed by moving unit",
            }
        )


class AIAircraftCrewMemberParachuteWasDestroyedByHumanAircraftTestCase(unittest.TestCase):

    def test_from_s(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByHumanAircraft.from_s(
            "[8:33:05 PM] r01000(0) has chute destroyed by User0:Bf-109G-2 at 100.0 200.99"
        )
        self.assertIsInstance(event, events.AIAircraftCrewMemberParachuteWasDestroyedByHumanAircraft)
        self.assertEqual(event.time, datetime.time(20, 33, 5))
        self.assertEqual(event.actor, actors.AIAircraftCrewMember("r0100", 0, 0))
        self.assertEqual(event.attacker, actors.HumanAircraft("User0", "Bf-109G-2"))
        self.assertEqual(event.pos, Point2D(100.0, 200.99))
    ...
    def test_to_primitive(self):
        event = events.AIAircraftCrewMemberParachuteWasDestroyedByHumanAircraft(
            time=datetime.time(20, 33, 5),
            actor=actors.AIAircraftCrewMember("r0100", 0, 0),
            attacker=actors.HumanAircraft("User0", "Bf-109G-2"),
            pos=Point2D(100.0, 200.99),
        ...
        self.assertEqual(
            event.to_primitive(),
            {
                ...
                'name': "AIAircraftCrewMemberParachuteWasDestroyedByHumanAircraft",
                'verbose_name': "AI aircraft crew member's parachute was destroyed by human aircraft",
            }
        )
