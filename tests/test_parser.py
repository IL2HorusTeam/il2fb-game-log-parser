...
class ParserTestCase(BaseTestCase):
    ...
    def test_parse_string(self):
        data = [
            ...
            (
                events.TreeWasDestroyedByAIAircraft,
            ...
            (
                events.MovingUnitWasDestroyedByMovingUnit,
                "[8:33:05 PM] 0_Chief destroyed by 1_Chief at 100.0 200.99"
            ),
            (
                events.MovingUnitWasDestroyedByMovingUnitMember,
            ...
            (
                events.MovingUnitMemberWasDestroyedByHumanAircraft,
                "[8:33:05 PM] 0_Chief0 destroyed by User:Pe-8 at 100.0 200.99"
            ),
            (
                events.MovingUnitMemberWasDestroyedByMovingUnit,
                "[8:33:05 PM] 0_Chief0 destroyed by 1_Chief at 100.0 200.99"
            ),
            (
                events.MovingUnitMemberWasDestroyedByMovingUnitMember,
            ...
            (
                events.AIAircraftWasShotDownByAIAircraft,
            ...
            (
                events.AIAircraftWasShotDownByMovingUnitMember,
            ...
            (
                events.AIAircraftCrewMemberWasKilledByMovingUnitMember,
            ...
            (
                events.AIAircraftCrewMemberParachuteWasDestroyed,
