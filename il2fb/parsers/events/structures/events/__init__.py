...
class AIAircraftWasDamagedByAIAircraft(EventWithTime,
                                       EventWithVictim,
                                       EventWithAggressor,
                                       EventWithPos,
                                       Event):
...
class AIHasDestroyedHisAircraft(EventWithTime,
                                EventWithVictim,
                                EventWithPos,
                                Event):
    """
...
class AIAircraftHasCrashed(EventWithTime,
                           EventWithVictim,
                           EventWithPos,
                           Event):
    """
...
class AIAircraftCrewMemberWasWounded(EventWithTime,
                                     EventWithVictim,
                                     EventWithPos,
                                     Event):
    """
...
class AIAircraftCrewMemberWasHeavilyWounded(EventWithTime,
                                            EventWithVictim,
                                            EventWithPos,
                                            Event):
    """
...
class AIAircraftCrewMemberHasBailedOut(EventWithTime,
                                       EventWithActor,
                                       EventWithPos,
                                       Event):
    """
