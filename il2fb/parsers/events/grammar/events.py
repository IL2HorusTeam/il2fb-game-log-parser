...
building_was_destroyed_by_moving_unit = Event(
    event_time
    + building_victim
    + " destroyed by "
    + moving_unit_aggressor
    + event_pos
).toStructure(events.BuildingWasDestroyedByMovingUnit)
...
tree_was_destroyed = Event(
    event_time
    + tree
    + " destroyed by"
    + event_pos
).toStructure(events.TreeWasDestroyed)
...
moving_unit_member_was_destroyed_by_ai_aircraft = Event(
    ...
    + ai_aircraft_aggressor
    + event_pos
).toStructure(events.MovingUnitMemberWasDestroyedByAIAircraft)

moving_unit_member_was_destroyed_by_human_aircraft = Event(
    event_time
    + moving_unit_member_victim
    + " destroyed by "
    + human_aircraft_aggressor
    + event_pos
).toStructure(events.MovingUnitMemberWasDestroyedByHumanAircraft)

moving_unit_member_was_destroyed_by_moving_unit = Event(
    event_time
    + moving_unit_member_victim
    + " destroyed by "
    + moving_unit_aggressor
...
ai_aircraft_was_shot_down_by_ai_aircraft = Event(
    event_time
    + ai_aircraft_victim
    + " shot down by "
    + ai_aircraft_aggressor
    + event_pos
).toStructure(events.AIAircraftWasShotDownByAIAircraft)
...
ai_aircraft_crew_member_was_killed_by_human_aircraft = Event(
    event_time
    + ai_aircraft_crew_member_victim
    + " was killed by "
    + human_aircraft_aggressor
    + event_pos
).toStructure(events.AIAircraftCrewMemberWasKilledByHumanAircraft)

ai_aircraft_crew_member_was_killed_by_ai_aircraft = Event(
    event_time
    + ai_aircraft_crew_member_victim
    + " was killed by "
    + ai_aircraft_aggressor
...
ai_aircraft_crew_member_parachute_was_destroyed = Event(
    event_time
    + ai_aircraft_crew_member_victim
    + " has chute destroyed by"
    + event_pos
).toStructure(events.AIAircraftCrewMemberParachuteWasDestroyed)
